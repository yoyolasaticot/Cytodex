        ...
        <div className="relative overflow-hidden rounded-[22px] border border-[#86e7ff]/18 bg-[linear-gradient(135deg,#071523_0%,#14354f_48%,#1a5674_72%,#ff8c43_100%)] p-5 text-white shadow-[0_18px_44px_rgba(1,8,18,0.32)]">
          ...
          <div className="relative flex flex-wrap items-start justify-between gap-4">
            <div className="max-w-3xl">
              ...
              <h1 className="font-heading text-2xl font-semibold leading-tight uppercase text-white sm:text-3xl">
                {title}
              </h1>
            ...
            <Button
              type="button"
              onClick={onBack}
              className="rounded-full border border-[#86e7ff]/34 bg-[#09131f]/44 px-5 py-2.5 text-sm font-semibold uppercase tracking-[0.16em] text-[#eafcff] backdrop-blur transition hover:-translate-y-0.5 hover:border-[#ffd166]/50 hover:text-[#fff3cf]"
            >
              {backLabel}
            </Button>
          </div>
